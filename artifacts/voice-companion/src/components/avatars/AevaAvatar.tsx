export function AevaAvatar({ size = 120 }: { size?: number }) {
  return (
    <svg width={size} height={size} viewBox="0 0 120 120" fill="none" xmlns="http://www.w3.org/2000/svg">
      <defs>
        <radialGradient id="aeva-bg" cx="50%" cy="50%" r="50%">
          <stop offset="0%" stopColor="#a78bfa" stopOpacity="0.3" />
          <stop offset="100%" stopColor="#4c1d95" stopOpacity="0.15" />
        </radialGradient>
        <radialGradient id="aeva-skin" cx="50%" cy="45%" r="55%">
          <stop offset="0%" stopColor="#fef0e0" />
          <stop offset="100%" stopColor="#f0d5b0" />
        </radialGradient>
        <clipPath id="aeva-circle">
          <circle cx="60" cy="60" r="58" />
        </clipPath>
      </defs>

      <circle cx="60" cy="60" r="58" fill="url(#aeva-bg)" />
      <circle cx="60" cy="60" r="58" stroke="#a78bfa" strokeWidth="1.5" strokeOpacity="0.4" />

      <g clipPath="url(#aeva-circle)">
        {/* Neck */}
        <rect x="50" y="91" width="20" height="18" rx="4" fill="url(#aeva-skin)" />
        ...
        {/* Head shape */}
        <ellipse cx="60" cy="63" rx="27" ry="30" fill="url(#aeva-skin)" />
