...
- [Supabase schema drift](supabase-schema-drift.md) — real data is in Supabase not DATABASE_URL; docstring migrations were never applied to prod; how to probe/fix
